...
| 2 | `_save/index.md` | 更新 wiki + 維護所有薄索引 + 輕量 schema 自檢 | 結構性問題自動修復；內容性問題會詢問 |
...
- Step 9 schema 結構性缺陷靜默修復（缺欄位補日期、日期格式修正，只查本次異動的 REQ/ADR 檔案）
...
- Step 7 教訓、模式與第三方服務坑
- Step 9 schema 內容性缺陷（缺驗收條件等，列出問題詢問是否補上）
